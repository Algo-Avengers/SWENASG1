...
- **`flask user add_student <student_id> <first_name> <last_name> <student_programme> <student_faculty>`**
...
- **`flask user add_review <student_id> <staff_id> <review_type> <course> <comment>`**
